...
watch(searchQuery, (value) => {
    ...
    searchTimeout = setTimeout(() => {
        router.get('/mahasiswa/riwayat-transaksi', 
...
const pageUrl = (page) => {
    ...
    return `/mahasiswa/riwayat-transaksi?${params.join('&')}`;
};
                                        ...
                                        <tr v-if="!payments || !payments.data || payments.data.length === 0">
                                            <td colspan="6" class="text-center py-5">
                                                <div class="d-flex flex-column align-items-center">
                                                    ...
                                                    <Link href="/mahasiswa/pembayaran" class="btn btn-primary">Bayar Sekarang</Link>
                                                </div>
                                            </td>
                                        </tr>
