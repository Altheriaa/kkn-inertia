...
const pageUrl = (page) => {
    ...
    return `/admin/dosen-dpl?${params.join('&')}`;
};

const paginationPages = computed(() => {
    const current = props.dosenDpls?.current_page || 1;
    const last = props.dosenDpls?.last_page || 1;
    const pages = [];
                                ...
                                <nav v-if="dosenDpls.last_page > 1">
                                    <ul class="pagination pagination-sm mb-0">
                                        ...
                                        <template v-for="(pg, idx) in paginationPages" :key="idx">
                                            ...
                                            <li v-else class="page-item" :class="{ active: pg === dosenDpls.current_page }">
